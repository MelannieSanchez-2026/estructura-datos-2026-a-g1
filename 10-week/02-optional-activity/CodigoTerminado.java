            ...
            */
            ...
            while(!numeroValido){
                try{
                    ...
                    System.out.print("Error: solo números. Intente nuevamente: ");
                    scanner.next();
                }
            }
            ...
            */
            ...
            while(!nombreCorrecto){
                ...
                if(entrada.matches("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+")){
                    ...
                    System.out.print("Nombre inválido. Solo letras: ");
                }
            }
            ...
            - Estructura básica: texto@texto.dominio
            ------------------------------------------------------------
            */
